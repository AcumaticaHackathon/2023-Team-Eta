...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" Runat="Server">
	<px:PXDataSource ID="ds" runat="server" Visible="True" Width="100%"
        TypeName="ACPROpenAI.Graph.ACPRSetupMaint"
        PrimaryView="Setup"
        >
		<CallbackCommands>
...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" Runat="Server">
	<px:PXFormView ID="form" runat="server" DataSourceID="ds" DataMember="Setup" Width="100%" AllowAutoHide="false">
		<Template>
			...
			<px:PXTextEdit runat="server" ID="CstPXTextEdit6" DataField="EndPoint" ></px:PXTextEdit></Template>
	...
	<px:PXSmartPanel Caption="Open AI Connection Test" CaptionVisible="True" Key="TestView" LoadOnDemand="True" Width="700" AllowResize="False" AutoReload="True" AutoRepaint="True" Position="CenterWindow" ShowAfterLoad="True" runat="server" ID="CstTestViewSmartPanel" >
		<px:PXFormView DataSourceID="ds" Width="100%" SkinID="Transparent" DataMember="TestView" runat="server" ID="CstTestViewForm" >
			<Template>
				...
				<px:PXTextEdit Size="" Style='width:;' TextMode="MultiLine" Width="100%" Height="250" SuppressLabel="True" TextAlign="Left" runat="server" ID="CstPXTextEdit21" DataField="Answer" ></px:PXTextEdit>
				...
				<px:PXTextEdit Placeholder="" SuppressLabel="False" Width="100%" Style='width:;' TextMode="SingleLine" runat="server" ID="CstPXTextEdit24" DataField="Prompt" ></px:PXTextEdit>
				<px:PXButton CommandSourceID="ds" CommandName="sendRequest" Text="Send" runat="server" ID="CstButton26" ></px:PXButton></Template></px:PXFormView>
		<px:PXPanel SkinID="Buttons" runat="server" ID="CstPanel16" >
			<px:PXButton DialogResult="Cancel" Text="Ok" runat="server" ID="CstButton17" ></px:PXButton></px:PXPanel></px:PXSmartPanel></asp:Content>